...
import CardImg from '../images/women-tshirt.jpg';
import '../styles/ActionAreaCardThree.css';

const ActionAreaCardThree = () => {
  return (
...
export default ActionAreaCardThree;
